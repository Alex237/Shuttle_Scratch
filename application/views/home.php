<nav id="subnavbar" role="navigation">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <ul>
                    <li class="active"><a href="#"><i class="fa-eye"></i>Accueil</a></li>
                    <li><a href="#"><i class="fa-clock-o"></i>Historique</a></li>
                    <li><a href="#"><i class="fa-ticket"></i>Tickets</a></li>
                    <li><a href="#"><i class="fa-bar-chart-o"></i>Statistiques</a></li>
                    <li><a href="#"><i class="fa-plus-circle"></i>Nouveau ticket</a></li>
                </ul>
            </div>
            <div class="col-md-4">
                <div class="row">
                    <form class="col-xs-12" role="search">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Trouver un ticket">
                            <span class="input-group-btn">
                                <button type="submit" class="btn btn-default"><i class="fa-search"></i></button>
                            </span>
                        </div>
                    </form>
                </div>
